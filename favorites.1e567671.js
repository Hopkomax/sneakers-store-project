...
function $448c8bee6521701e$var$handleAuthStateChanged(user) {
    if (user) {
        ...
        unsubscribe = (0, $eJHP4.db).firestore().collection("favorites").where("userId", "==", (0, $eJHP4.db).auth().currentUser.uid).onSnapshot((snapshot)=>{
            const favorites = snapshot.docs.map((doc)=>doc.data()) || [];
...
//# sourceMappingURL=favorites.1e567671.js.map
