...
`;
   ...
   */ const renderProgressSteps = (instance, params)=>{
        ...
        const { progressSteps: progressSteps , currentProgressStep: currentProgressStep  } = params;
...
if (typeof module.exports !== "undefined" && module.exports.Sweetalert2) module.exports.swal = module.exports.sweetAlert = module.exports.Swal = module.exports.SweetAlert = module.exports.Sweetalert2;
...
function $6c7efde1355f19a5$export$f43df08f77b54999() {
    ...
    unsubscribe = (0, $eJHP4.db).firestore().collection("cart").where("userId", "==", currentUser.uid).onSnapshot((snapshot)=>{
...
let $22f954899530a68f$var$unsubscribe = null;
...
function $22f954899530a68f$export$ea6ae64fa989b7ac(evt) {
    ...
    if (modalBtnOpen) {
        ...
        $22f954899530a68f$var$unsubscribe = (0, $eJHP4.db).firestore().collection("cart").where("userId", "==", (0, $eJHP4.db).auth().currentUser.uid).onSnapshot((snapshot)=>{
            const inCart = snapshot.docs.map((doc)=>doc.data()) || [];
            console.log(inCart);
            if (inCart.length === 0) {
...
//# sourceMappingURL=purchases.17476ecb.js.map
