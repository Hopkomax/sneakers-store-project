...
function $ac329baf2538dd87$var$handleAuthStateChanged(user) {
    if (user) {
        ...
        unsubscribe = (0, $iqmmd.db).firestore().collection("favorites").where("userId", "==", (0, $iqmmd.db).auth().currentUser.uid).onSnapshot((snapshot)=>{
            const favorites = snapshot.docs.map((doc)=>doc.data()) || [];
...
//# sourceMappingURL=favorites.258a7f6e.js.map
