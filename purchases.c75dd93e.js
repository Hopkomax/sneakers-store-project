...
function $87c01b5d679bdfc8$export$f43df08f77b54999() {
    ...
    unsubscribe = (0, $iqmmd.db).firestore().collection("cart").where("userId", "==", currentUser.uid).onSnapshot((snapshot)=>{
...
let $1d6afae14448cd82$var$unsubscribe = null;
...
function $1d6afae14448cd82$export$ea6ae64fa989b7ac(evt) {
    ...
    if (modalBtnOpen) {
        ...
        $1d6afae14448cd82$var$unsubscribe = (0, $iqmmd.db).firestore().collection("cart").where("userId", "==", (0, $iqmmd.db).auth().currentUser.uid).onSnapshot((snapshot)=>{
            const inCart = snapshot.docs.map((doc)=>doc.data()) || [];
            console.log(inCart);
            if (inCart.length === 0) {
...
//# sourceMappingURL=purchases.c75dd93e.js.map
